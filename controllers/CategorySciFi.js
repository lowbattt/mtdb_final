...
const categorySciFi = async (req, res) => {
  try {
...
res.render('categorySciFi', { movieNames, movieRates, movieGenre1, movieGenre2, movieDescription, movieWriter, movieStars, movieImages, movieVideos });
