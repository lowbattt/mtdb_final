...
const categoryRomance = async (req, res) => {
  try {
...
res.render('categoryRomance', { movieNames, movieRates, movieGenre1, movieGenre2, movieDescription, movieWriter, movieStars, movieImages, movieVideos });
...
module.exports = categoryRomance;
