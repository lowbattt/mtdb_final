...
const categoryAdventure = async (req, res) => {
  try {
...
res.render('categoryAdventure', { movieNames, movieRates, movieGenre1, movieGenre2, movieDescription, movieWriter, movieStars, movieImages, movieVideos });
...
module.exports = categoryAdventure;
