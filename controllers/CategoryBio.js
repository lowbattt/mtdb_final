...
const categoryBio = async (req, res) => {
  try {
...
res.render('categoryBio', { movieNames, movieRates, movieGenre1, movieGenre2, movieDescription, movieWriter, movieStars, movieImages, movieVideos });
