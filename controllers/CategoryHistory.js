...
const categoryHistory = async (req, res) => {
  try {
...
res.render('categoryHistory', { movieNames, movieRates, movieGenre1, movieGenre2, movieDescription, movieWriter, movieStars, movieImages, movieVideos });
