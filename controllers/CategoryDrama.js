...
const CategoryDrama = async (req, res) => {
  try {
...
res.render('categoryDrama', { movieNames, movieRates, movieGenre1, movieGenre2, movieDescription, movieWriter, movieStars, movieImages, movieVideos });
