...
const categoryFantasy = async (req, res) => {
  try {
...
res.render('categoryFantasy', { movieNames, movieRates, movieGenre1, movieGenre2, movieDescription, movieWriter, movieStars, movieImages, movieVideos });
...
module.exports = categoryFantasy;
