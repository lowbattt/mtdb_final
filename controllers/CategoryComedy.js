...
const categoryComedy = async (req, res) => {
  try {
...
res.render('categoryComedy', { movieNames, movieRates, movieGenre1, movieGenre2, movieDescription, movieWriter, movieStars, movieImages, movieVideos });
